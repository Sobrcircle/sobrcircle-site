    ...
    <section className="ld-section ld-story" id="story">
      ...
      <div className="ld-prose">
        ...
        <p data-animate data-delay="0.1">
          ...
          the point where staying is easy &mdash; because they were once met
          that way themselves, in their own dark, and you cannot be handed
          something like that and keep it.
        </p>
        <p data-animate data-delay="0.2">
          Today two lives become one. The work does not change. There is
